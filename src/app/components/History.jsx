...
const CHAPTERS = [
  ...
  },
  {
    ...
    body:
      'ТОС активно принимает участие в региональных программах. В 2023, 2025, 2026 гг. проекты ТОСа выиграли гранты на благоустройство по региональной программе поддержки местных инициатив, участие и победа в этой программе дали основной импульс для развития площадки «Берег Детства».',
  ...
  },
  {
    ...
    body:
      'Прошли программу обучения проектированию и функциональному планированию и озеленению городских пространств. Неоднократно побеждали в конкурсе ландшафтных проектов «Цветущий город». Пузыреплодник, клёны, спирея, декоративные злаки — у каждого растения своё место и свой сезон.',
