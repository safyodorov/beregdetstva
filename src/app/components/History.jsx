...
const CHAPTERS = [
  ...
  },
  {
    ...
    body:
      'Прошли программу обучения проектировке и функциональному планированию и озеленению городских пространств. Неоднократно побеждали в конкурсе ландшафтных проектов «Цветущий город». Пузыреплодник, клёны, спирея, декоративный злаки — у каждого растения своё место и свой сезон.',
