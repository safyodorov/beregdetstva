...
const CHAPTERS = [
  ...
  },
  {
    ...
    body:
      'ТОС активно принимает участие в региональных программах. В 2024, 2025, 2026 гг. проекты ТОСа выиграли гранты на благоустройство по региональной программе поддержки местных инициатив, участие и победа в этой программе дали основной импульс для развития площадки «Берег Детства».',
    photo: '/photos/local-initiatives.jpg',
    accent: '#6b5ca3',
  },
  {
    n: '1.8',
    ...
    body:
      'Команда ТОСа прошла программу обучения проектированию и функциональному планированию и озеленению городских пространств. Неоднократно побеждала в конкурсе ландшафтных проектов «Цветущий город». Пузыреплодник, клёны, спиреи, декоративные злаки — у каждого растения своё место и свой сезон.',
