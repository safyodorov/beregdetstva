...
const YEARS = [
  {
    year: '2024',
    title: 'Цветы вдоль улицы Парковой',
    desc:
      'Наш первый сезон в программе. Высадили 1 200 однолетников: петунии, бархатцы, цинии. Красивая бессистемность — учились.',
  ...
  {
    year: '2025',
    title: 'Многолетники и ягодные острова',
    desc:
      'Перешли на многолетники: пузыреплодник краснолистный, спирея, ирисы. Меньше ухода, больше структуры. Плюс шесть клёнов Глобозум.',
    ...
    <section id="landscape" className="section section--landscape" data-screen-label="03 Ландшафт">
      <div className="container">
        <div className="section-heading">
          ...
          <p className="lede">
            Мы — участники программы <strong>«Цветущий город»</strong> Ивановской области. Это не
            клумбы, а план многолетнего пейзажа: чтобы цвело с апреля по октябрь и не требовало
            марафонских усилий.
          </p>
        </div>
