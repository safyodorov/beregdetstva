...
const STAGES = [
  {
    ...
    colour: '#c24a4a',
    desc:
      'Безопасный островок для детей 1–5 лет: песочница, качалки, мини-кухня, песочница, лабиринт и качелини. Сюда приходят мамы с колясками, родители с малышами, бабушки с внуками.',
  ...
  },
  {
    ...
    photoSchema: '/photos/stage2/plan.jpg',
    items: [
      { n: 'Игровой комплекс «Грани»', size: '10600 × 6168 × 2422 мм', note: 'Арт. 115.82.00', photo: '/photos/stage2/item-1.jpg' },
      { n: 'Скамья', size: '600 × 2000 × 890 мм', note: 'Арт. ДП-2', photo: '/photos/stage2/item-2.jpg' },
    ],
  },
  {
    id: 3,
    ...
    photoSchema: '/photos/stage3/plan.jpg',
    items: [
      { n: 'Парковые качели «Гранит»', size: '2700 × 900 × 2530 мм', note: 'Арт. 108-01.108.20-20', photo: '/photos/stage3/item-1.jpg' },
      { n: 'Скамья стальная «Модерн»', size: '2000 × 610 × 835 мм', note: 'Арт. 7106', photo: '/photos/stage3/item-2.jpg' },
    ],
  },
  {
    id: 4,
    ...
    photoSchema: '/photos/stage4/plan.jpg',
    items: [
  ...
  },
  {
    ...
    photoSchema: '/photos/stage5/plan.jpg',
    items: [],
    open: true,
  },
];
    ...
    <section id="stages" className="section section--stages" data-screen-label="02 Этапы">
      <div className="container">
        <div className="section-heading">
          ...
          <p className="lede">
            Пять пронумерованных этапов, от площадки для самых маленьких до открытого вопроса.
            ...
            {stage.open ? (
              <div className="open-question">
                ...
                <a
                  ...
                  href="mailto:newderyabiha@gmail.com?subject=Идея для пятого этапа"
                >
                  Предложить идею
                </a>
              </div>
