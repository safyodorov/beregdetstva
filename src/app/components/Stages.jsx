...
const STAGES = [
  {
    ...
    items: [
      ...
      {
        n: 'Качалка-пружина «Машинка»',
        size: '900 × 400 × 700 мм',
        note: 'Для одного ребёнка, от 1 года.',
        photo: '/photos/stage0/item-2.jpg',
      },
      {
        n: 'Домик «Теремок»',
        size: '1500 × 1500 × 1700 мм',
        note: 'Полуоткрытый, с окошком и столиком.',
        photo: '/photos/stage0/item-3.jpg',
      },
      {
        n: 'Мини-горка',
        size: '2200 × 600 × 1500 мм',
        note: 'Высота ската 90 см, борт безопасности.',
        photo: '/photos/stage0/item-4.jpg',
      },
      {
        n: 'Качели-балансир «Уточка»',
        size: '1800 × 400 × 900 мм',
        note: 'На пружинах, для двоих детей от 2 лет.',
