...
const STAGES = [
  ...
  },
  {
    ...
    items: [
      { n: 'Пирамида канатная «Парус»', size: '4000 × 4000 × 4500 мм', note: 'Страховочная сетка по периметру.', photo: '/photos/stage2/item-1.jpg' },
      { n: 'Гамак-карусель', size: 'Ø 1500 мм', note: 'Для компании из 3–4 детей.', photo: '/photos/stage2/item-2.jpg' },
    ],
  },
  {
    id: 3,
