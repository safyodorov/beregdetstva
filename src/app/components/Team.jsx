...
const TEAM = [
  ...
  { n: 'Татьяна Арефьева', r: 'Казначей', b: 'Самый ответственный участник команды. Следит за финансами, расписанием и за всеми нами.', photo: '/photos/team/tatyana-arefieva.jpg' },
  { n: 'Юлия Налимова', r: 'Коммуникации', b: 'Фотографии, тексты, соцсети. Наш голос в интернете и в чате микрорайона.', photo: '/photos/team/yulia-nalimova.jpg' },
  ...
  { n: 'Алексей Чистяков', r: 'Техническая часть', b: 'Сборка, ремонт. Человек надёжный и чёткий как швейцарский нож.', photo: '/photos/team/aleksey-chistyakov.jpg' },
  { n: 'Ангелина Горнушкина', r: 'Хранительница очага', b: 'Забота о каждом члене нашей команды, всегда рядом — поможет и поддержит.', photo: '/photos/team/angelina-gornushkina.jpg' },
  { n: 'Александр Горнушкин', r: 'Зелёный атаман', b: 'Лопата в его руках — как кисточка в руках художника: он не копает, он творит. Всегда бодр и добр!', photo: '/photos/team/aleksandr-gornushkin.jpg' },
  { n: 'Елена Козлова', r: 'Муза', b: 'Вдохновляет команду на подвиги. Выводит соседей и не только на субботники. Электровеник нашей команды.', photo: '/photos/team/elena-kozlova.jpg' },
];
